...
PROFILES_JSON='[
  ...
  [
    {"type": "gauss", "params": {"A": -8}, "label": "Gaussian (A=-8)", "name": "pr4"},
  ...
  [
    ...
    {"type": "gauss", "params": {"A": 8}, "label": "Gaussain (A=8)", "name": "pr11"}
  ],
    [
    ...
    {"type": "gauss", "params": {"A": 8, "k": 0}, "label": "Gaussain (A=8)", "name": "pr17"}
  ]
]'

python /home/val2204/translocation-task/new_different_depths.py --profiles_json "$PROFILES_JSON" --N 50 100 > ${OUTFILE} 2> ${ERRFILE}